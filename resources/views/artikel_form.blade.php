            ...
            <div class="col-lg-4">
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select rounded-pill-input" name="status_artikel" id="status_artikel" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control rounded-pill-input"
                                   name="penulis_artikel" id="penulis_artikel"
                        ...
                        <div class="mb-0">
                            ...
                            <input type="date" class="form-control rounded-pill-input"
                                   name="tanggal_terbit_artikel" id="tanggal_terbit_artikel"
                                   value="{{ $tgl }}"
                                   required>
                        </div>
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3 {{ (isset($artikel) && $artikel->foto_artikel) ? 'd-none' : '' }}" id="uploadContainer">
                        ...
                        <div id="previewContainer" class="position-relative {{ isset($artikel) && $artikel->foto_artikel ? '' : 'd-none' }}">
                            ...
                            <div style="width: 100%; aspect-ratio: 16/9; overflow: hidden; border-radius: 12px; position: relative; background: #f0f0f0;">
                                <img id="fotoPreview" 
                            ...
                            {{-- Tombol Hapus --}}
                            <button type="button" id="clearFile" class="btn btn-danger btn-sm position-absolute rounded-circle shadow-sm d-flex align-items-center justify-content-center" 
                                    style="top: 10px; right: 10px; width: 32px; height: 32px; padding: 0; z-index: 10;">
                                <i class="bi bi-x-lg"></i>
                            </button>
                            
                            {{-- Tombol Ubah (Trigger file input) --}}
                            <label for="foto_artikel" class="btn btn-light btn-sm position-absolute rounded-pill shadow-sm small fw-bold" 
                ...
                <div class="d-grid gap-2">
                    <button type="submit" id="btnSimpan" class="btn btn-gradient-green rounded-pill py-3 fw-bold shadow-sm">
...
<style>
    ...
    .btn-gradient-green:hover { background: linear-gradient(135deg, #157347, #198754); transform: translateY(-2px); color: white; box-shadow: 0 5px 15px rgba(25, 135, 84, 0.3) !important; }
    .rounded-pill-input { border-radius: 50px !important; border: 1px solid #d1d5db; padding-left: 20px; }
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // A. Saat File Dipilih -> Buka Modal Crop
    if (fotoInput) {
    ...
    // D. Batal Crop
    const handleCancel = () => { fotoInput.value = ''; closeCropModal(); };
    ...
    form.onsubmit = async function(e) {
        ...
        if (textOnly.length === 0) {
            Swal.fire({ icon: 'warning', title: 'Konten Kosong', text: 'Silakan tulis isi artikel terlebih dahulu!' });
            return;
        }
        ...
        // Ganti file input asli dengan Blob Cropped (jika ada)
        if (croppedBlob) {
            formData.set('foto_artikel', croppedBlob, originalFileName);
        }

        // Tentukan URL (Store vs Update)
        ...
        try {
            const res = await fetch(url, {
                method: 'POST', // Method POST digunakan untuk FormData (Laravel _method handles PUT)
            ...
            if (res.ok) {
                Swal.fire({
                    icon: 'success', title: 'Berhasil!', text: data.message || 'Artikel berhasil disimpan.',
