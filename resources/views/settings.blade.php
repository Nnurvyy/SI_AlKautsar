                ...
                <div class="card-body">
                        ...
                        <div class="col-md-12 text-center">
                            ...
                            <div id="previewFotoMasjidContainer" class="mb-3 {{ $settings->foto_masjid ? '' : 'd-none' }}">
                                <img id="previewFotoMasjid"
                                    ...
                                    alt="Preview Foto" class="img-thumbnail shadow-sm"
                            ...
                            <div class="d-flex justify-content-center align-items-center gap-2">
                                <div class="d-inline-block">
                                    <input class="form-control" type="file" id="foto_masjid" name="foto_masjid"
                                        accept="image/*">
                                </div>

                                {{-- Tombol Hapus (Muncul jika ada foto) --}}
                                <button type="button" id="clearFotoMasjid"
                                    class="btn btn-outline-danger {{ $settings->foto_masjid ? '' : 'd-none' }}"
                                    title="Hapus Foto">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="position-relative mb-3">
                            ...
                            <button type="button" id="btnCurrentLocation"
                                class="btn btn-light btn-sm position-absolute shadow-sm"
                                style="top: 10px; right: 10px; z-index: 400;">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="bi bi-whatsapp text-success me-1"></i> WhatsApp (No.
                                HP)</label>
                            <input type="text" class="form-control" name="social_whatsapp"
                                value="{{ $settings->social_whatsapp }}" placeholder="Contoh: 6281234567890">
                            <div class="form-text small">Gunakan format 62... tanpa spasi/strip.</div>
                        </div>

                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="bi bi-instagram text-danger me-1"></i> Instagram (Link
                                Profil)</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="bi bi-facebook text-primary me-1"></i> Facebook (Link
                                Halaman)</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="bi bi-youtube text-danger me-1"></i> YouTube (Link
                                Channel)</label>
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label"><i class="bi bi-twitter text-info me-1"></i> Twitter / X (Link
                                Profil)</label>
                    ...
                    <div class="mt-4">
                        <button type="submit" class="btn btn-primary w-100 fw-bold py-2"><i class="bi bi-save me-2"></i>
...
@push('scripts')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const fotoLabelSpan = document.querySelector('#foto_masjid_label span');
                ...
                try {
                    ...
                    if (res.ok) {
                        ...
                        if (res.status === 422 && data.errors) {
                            let errorMessages = Object.values(data.errors).map(err => err[0]).join(
                                '<br>');
