...
@push('styles')
    <style>
        ...
        /* Z-Index Fix untuk Modal Bertumpuk */
        ...
        /* Styling untuk Dynamic Row Hewan */
    ...
    <div class="container-fluid p-4">
        ...
        <div class="card shadow-sm border-0 mb-4">
            <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
                <h5 class="mb-0 fw-bold"><i class="bi bi-filter me-2"></i>Filter Laporan PDF</h5>
            </div>
            <div class="card-body">
        ...
        <div class="row g-3 mb-4">
            ...
            <div class="col-12">
                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                    ...
                    {{-- Kiri: Input Pencarian (Lebih Lebar) --}}
                    ...
                    <div class="d-flex gap-2">
                        <button class="btn btn-warning shadow-sm fw-bold text-dark" data-bs-toggle="modal" data-bs-target="#modalHargaHewan" onclick="loadListHarga()">
                            <i class="bi bi-tag-fill me-1"></i> Harga
                        </button>
                        <button class="btn btn-primary shadow-sm fw-bold" onclick="openModalCreate()">
                            <i class="bi bi-plus-circle me-1"></i> Tabungan Baru
                        </button>
                    </div>
                </div>
            </div>

            {{-- BARIS 2: Panel Filter (Background Abu-abu tipis biar rapi) --}}
            <div class="col-12">
                <div class="card border-0 shadow-sm bg-light">
                    <div class="card-body p-2 d-flex flex-wrap align-items-center gap-2">
                        ...
                        {{-- Tombol Reset Filter (Opsional, pemanis UX) --}}
                    ...
                    <table class="table table-hover align-middle mb-0" id="tabelTabungan">
                        <thead class="table-light">
                            <tr>
                                ...
                                <th class="text-end" width="15%">Target & Terkumpul</th>
                                <th class="text-center" width="10%">Tipe</th>
                                <th class="text-center" width="10%">Status Tabungan</th>
                                <th class="text-center" width="10%">Status Setoran</th>
                ...
                <div class="modal-body">
                    <div class="alert alert-light border d-flex justify-content-between align-items-center">
                        <div>
                            ...
                            <strong id="detailSavingType" class="fs-5">-</strong>
                        </div>
                        <div class="text-end">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <button class="btn btn-sm btn-success" onclick="openModalSetor()">
                            <i class="bi bi-plus-lg"></i> Tambah Setoran
                        </button>
                    </div>
                    <div class="table-responsive border rounded" style="max-height: 300px;">
                        <table class="table table-sm table-striped mb-0">
                            ...
                            <tbody id="tabelRiwayatSetoran"></tbody>
                        </table>
                    </div>
                </div>
                <div class="modal-footer">
...
{{-- Load Script Eksternal yang baru dibuat --}}
