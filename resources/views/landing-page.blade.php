...
@section('content')
    ...
    <section class="hero-section" id="hero-section">
        <img src="{{ $masjidSettings->foto_masjid ? Storage::url($masjidSettings->foto_masjid) : asset('images/masjid.jpeg') }}"
            id="hero-bg-image" alt="Hero Background">
            ...
            <div class="container px-4">
                <div class="feature-grid">
                    ...
                    <a href="{{ route('public.tabungan-qurban-saya') }}" class="feature-item bg-teal">
                        <img src="{{ asset('images/icons/qurban.png') }}" alt="Tabungan Qurban Icon"
                    ...
                    <a href="{{ route('public.jadwal-khotib') }}" class="feature-item bg-indigo">
                        <img src="{{ asset('images/icons/khutbah-jumat.png') }}" alt="Khutbah Icon"
                            class="feature-icon-img">
                ...
                .then(data => {
                    if (data.status && data.data && data.data.jadwal) {
                        ...
                        for (const prayer of prayerTimes) {
                            ...
                            if (prayerDate > now) {
                                nextPrayerElementMobile = document.getElementById(prayer.id_m)?.closest(
                                    '.prayer-card');
                                break;
                            }
                        }
                        ...
                        if (!nextPrayerElementMobile) {
                            nextPrayerElementMobile = document.getElementById('time-subuh-m')?.closest(
                                '.prayer-card');
                        }

                        document.querySelectorAll('.prayer-times-in-card .prayer-card').forEach(card => card
