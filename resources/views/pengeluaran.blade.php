    ...
    <div class="container-fluid p-4">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
            ...
            <div class="d-flex align-items-center mt-2 mt-md-0">
                ...
                <button type="button" class="btn btn-danger" id="btnTambahPengeluaran">
        ...
        <div class="d-flex justify-content-between align-items-center p-3 bg-white rounded shadow-sm mb-4">
            ...
            <h5 class="fw-bold mb-0 text-danger" id="textTotalPengeluaran">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-hover align-middle" id="tabelKeuangan">
                        ...
                        <tbody>
                            {{-- Data dimuat via JS (Warna merah otomatis handled by JS 'nominalClass') --}}
                        </tbody>
                    </table>
                </div>
                {{-- Pagination --}}
                    ...
                    <div class="modal-body p-4">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group input-group-lg shadow-sm">
                                <span class="input-group-text bg-white text-success fw-bold border-end-0"
                                    style="border-top-left-radius: 10px; border-bottom-left-radius: 10px;">Rp</span>
                        ...
                        <div class="row g-3 mb-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control py-2" name="tanggal" id="inputTanggal" required
                                    value="{{ date('Y-m-d') }}" style="border-radius: 8px;">
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-bold small text-muted">Kategori</label>
                                <select class="form-select py-2" name="id_kategori_keuangan" id="selectKategori" required
                        ...
                        <div class="mb-2">
                            ...
                            <textarea class="form-control" name="deskripsi" id="inputDeskripsi" rows="3"
                                placeholder="Contoh: Sedekah hamba Allah..." style="border-radius: 8px;"></textarea>
                        </div>
                    </div>

                    <div class="modal-footer border-0 px-4 pb-4">
                        <button type="button" class="btn btn-light fw-bold text-muted px-4" data-bs-dismiss="modal"
                        ...
                        <button type="submit" class="btn btn-success fw-bold px-4 py-2 shadow-sm"
                            id="btnSimpanTransaksi" style="border-radius: 8px; min-width: 120px;">
                ...
                <div class="modal-body p-4">
                    ...
                    <form id="formKategori" class="mb-4">
                        ...
                        <div class="input-group shadow-sm" style="border-radius: 10px; overflow: hidden;">
                            <input type="text" class="form-control border-0 py-2 bg-light" id="nama_kategori"
                                name="nama_kategori_keuangan" placeholder="Tulis kategori baru..." required>
...
@push('scripts')
    ...
    <script>
        const TIPE_HALAMAN = 'pengeluaran';
        const URL_API_TRANSAKSI = '/pengurus/pengeluaran';
        const URL_API_KATEGORI = '/pengurus/kategori-keuangan';
    </script>
    {{-- JS yang sama dengan Pemasukan --}}
