...
<div class="container-fluid p-4">
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
        ...
        <div class="d-flex align-items-center mt-2 mt-md-0">
            ...
            {{-- PERUBAHAN 1: Tombol jadi Merah (btn-danger) --}}
    ...
    <div class="d-flex justify-content-between align-items-center p-3 bg-white rounded shadow-sm mb-4">
        ...
        {{-- PERUBAHAN 2: Teks Total jadi Merah (text-danger) --}}
        ...
        <div class="modal-content">
            <form id="formTransaksi">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="modalTransaksiTitle">Tambah Pengeluaran</h5>
                ...
                <div class="modal-footer">
                    ...
                    {{-- PERUBAHAN 3: Tombol Simpan jadi Merah (btn-danger) agar konsisten --}}
...
<script>
    // Konfigurasi Halaman Pengeluaran
