...
@section('content')
    ...
    <style>
        .auth-screen {
            ...
            min-height: 100vh;
            padding: 20px 0;
            position: relative; /* Penting agar tombol back bisa di-posisikan absolute relatif terhadap layar */
        }
        ...
        /* Style tambahan agar tombol back berubah warna saat di-hover */
        .back-link {
    ...
    <a href="{{ route('register') }}" class="back-link" title="Kembali ke Register" style="position: absolute; top: 20px; left: 20px; z-index: 10;">
        ...
        <div class="auth-content">
            ...
            <form action="{{ route('auth.verify.process') }}" method="POST">
                ...
                <div class="form-group">
                    <input type="text" name="otp" class="form-control text-center" placeholder="XXXXXX" maxlength="6" required style="letter-spacing: 5px; font-size: 1.5rem;">
                    @error('otp')
            ...
            <div class="mt-3 text-center">
                <form action="{{ route('auth.otp.resend') }}" method="POST">
                    ...
                    <button type="submit" class="btn btn-link small text-muted text-decoration-none p-0 border-0 bg-transparent">
                        Kirim Ulang OTP
                    </button>
                </form>
            </div>
