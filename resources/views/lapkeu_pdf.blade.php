...
<head>
    ...
    <style>
        ...
        /* Summary Table Styling (Tanpa border penuh biar rapi) */
        .summary-container { width: 100%; overflow: hidden; }
        .summary { float: right; width: 40%; margin-top: 10px; }
        .summary th, .summary td { border: 1px solid #ddd; padding: 5px; }
        .summary th { background-color: #fff; text-align: left; }
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end"><strong>Rp {{ number_format($pemasukanData->sum('nominal'), 0, ',', '.') }}</strong></td>
                </tr>
                @endif
            </tbody>
        </table>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-end"><strong>Rp {{ number_format($pengeluaranData->sum('nominal'), 0, ',', '.') }}</strong></td>
                </tr>
                @endif
            </tbody>
        </table>
    ...
    <div class="summary-container">
        <table class="summary">
            <tr>
                ...
                <td class="text-end text-success" style="color: green;">Rp {{ number_format($totalPemasukan, 0, ',', '.') }}</td>
            </tr>
            <tr>
                <th>Total Pengeluaran</th>
                <td class="text-end text-danger" style="color: red;">(Rp {{ number_format($totalPengeluaran, 0, ',', '.') }})</td>
            </tr>
            <tr>
                <th style="background-color: #eee;"><strong>Saldo Akhir</strong></th>
                <td class="text-end" style="background-color: #eee;"><strong>Rp {{ number_format($saldo, 0, ',', '.') }}</strong></td>
            </tr>
        </table>
    </div>
