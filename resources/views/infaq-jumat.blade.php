    ...
    <div class="container-fluid p-4">
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center mb-4">
            ...
            <button class="btn btn-gradient-green rounded-pill px-4 shadow-sm" data-bs-toggle="modal"
                data-bs-target="#modaltambahinfaq" id="btnTambahInfaq">
                    ...
                    <form id="formTambahInfaq">
                        ...
                        <div class="donation-card-wrapper">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="date" class="form-control rounded-pill-input" id="tanggal_infaq"
                                    name="tanggal_infaq" required>
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group rounded-pill-group">
                                    ...
                                    <input type="text" class="form-control border-start-0 ps-1 fw-bold text-dark"
                                        id="nominal_infaq" name="nominal_infaq" placeholder="0" required autocomplete="off">
                                </div>
