...
<style>
    ...
    .program-slide-badge {
        display: inline-block; padding: 0.3em 0.8em; font-size: 0.8rem; font-weight: 700;
        border-radius: 50px; background-color: rgba(255, 255, 255, 0.2); color: white;
    ...
    .program-slide-content h5 {
        font-weight: 700; font-size: 1.5rem; text-shadow: 0 2px 4px rgba(0, 0, 0, 0.6);
        margin-bottom: 0.5rem; line-height: 1.3;
    }
    .program-slide-content p {
        font-size: 1.0rem; margin-bottom: 1rem; line-height: 1.5; font-weight: 500; color: #f8f9fa;
    }

    /* Tombol Detail di Slider */
    .btn-slide-detail {
        background-color: white; color: #333; border: none;
        padding: 0.5rem 1.2rem; border-radius: 50px; font-weight: 600; font-size: 0.9rem;
    ...
    .program-list-card .card-date, .program-list-card .card-location {
    ...
    .program-list-card .btn-detail-small {
        ...
        border-radius: 50px; background-color: #0d6efd; border: none;
        color: white; text-decoration: none; transition: background 0.2s;
        display: inline-block;
    }
    .program-list-card .btn-detail-small:hover { background-color: #0b5ed7; }
    ...
    @media (min-width: 768px) {
        .program-list-grid { display: grid; grid-template-columns: repeat(2, 1fr); gap: 1.5rem; }
    }
    ...
    .modal-program-value { font-size: 1rem; font-weight: 600; color: #333; margin-bottom: 1rem; }
    .modal-program-desc { font-size: 0.95rem; line-height: 1.6; color: #444; }
</style>
@endpush
...
<div class="container pt-4 pb-3">
    ...
    <p class="program-title-sub">Ikuti kegiatan dan workshop terbaru dari kami untuk meningkatkan keimanan dan wawasan.</p>
</div>
                ...
                <div class="swiper-slide">
                    <div class="program-slide">
                        ...
                        <div class="program-slide-content">
                            ...
                            {{-- Tombol Detail di Slider --}}
                            <button type="button" class="btn-slide-detail" onclick="showDetailProgram('{{ $item->id_program }}')">
                                Lihat Detail
                            </button>
                        </div>
                    </div>
                ...
                <div class="row g-0 h-100">
                    ...
                    <div class="col-7">
                        <div class="card-body">
                            ...
                            <div class="text-end">
                                <button type="button" class="btn-detail-small" onclick="showDetailProgram('{{ $program->id_program }}')">
                                    Lihat Detail
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <div class="modal-program-value">
                                <i class="bi bi-calendar3 me-2 text-primary"></i> <span id="modalProgramDate"></span><br>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        if(document.querySelector('.program-swiper')) {
            new Swiper('.program-swiper', { 
                ...
                navigation: { nextEl: '.program-button-next', prevEl: '.program-button-prev' },
                breakpoints: {
    ...
    function showDetailProgram(id) {
        ...
        fetch(`/program/detail/${id}`)
            ...
            .then(data => {
                ...
                // Ganti baris baru dengan <br> untuk deskripsi
