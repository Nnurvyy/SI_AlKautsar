...
<style>
    ...
    /* Social Media Buttons Custom Style */
    .contact-btn {
        display: flex;
        align-items: center;
        padding: 1rem;
    ...
    .btn-fb { background: linear-gradient(45deg, #3b5998, #192f5d); }
...
<div class="container" style="max-width: 900px;">
    ...
    <div class="mb-5">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <a href="https://wa.me/{{ $masjidSettings->social_whatsapp }}" target="_blank" class="contact-btn btn-wa">
