                        ...
                        <div class="card artikel-card">
                            <div class="card-body artikel-card-body">
                                ...
                                <div class="artikel-info">
                                    ...
                                    <button type="button" class="btn-artikel"
                                        onclick="showDetailArtikel('{{ $item->id_artikel }}')">
                                        Baca Selengkapnya
                                    </button>
                                </div>
                            </div>
        ...
        function showDetailArtikel(id) {
            ...
            fetch(`/artikel/detail/${id}`)
                ...
                .then(data => {
                    ...
                    document.getElementById('modalArtikelDate').innerHTML =
                        '<i class="bi bi-calendar-event me-2"></i>' + data.formatted_date;
                    document.getElementById('modalArtikelAuthor').innerHTML =
                        '<i class="bi bi-person-circle me-2"></i>' + data.penulis_artikel;
