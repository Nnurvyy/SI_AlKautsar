    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            filterBtn.addEventListener('click', function() {
                ...
                const url =
                    `{{ route('public.jadwal-adzan.api') }}?lokasi_id=${lokasiId}&bulan=${bulan}&tahun=${tahun}`;
                ...
                fetch(url, {
                    ...
                    .then(data => {
                        if (data.success) {
                            cardSubtitle.textContent =
                                `${data.lokasi} - ${namaBulan[parseInt(bulan, 10)]} ${tahun}`;
                            tableBody.innerHTML = '';
                    ...
                    `;
                            ...
                            Swal.fire('Gagal', data.message || 'Terjadi kesalahan tidak diketahui.',
                                'error');
                        }
                    })
                    .catch(error => {
