            ...
            <div class="d-flex flex-wrap align-items-center">
                ...
                <div class="input-group search-bar me-2 mb-2 mb-md-0" style="width: 300px;">
                    ...
                    <input type="text" id="searchInput" class="form-control border-start-0"
                        placeholder="Cari penceramah / tema...">
                </div>
            </div>
                    ...
                    <div class="modal-body">
                        <div class="form-wrapper">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="file" class="d-none" id="foto_penceramah" name="foto_penceramah"
                                    accept="image/*">

                                <div class="position-relative custom-file-wrapper mb-2">
                                    <label for="foto_penceramah" id="foto_penceramah_label"
                                        class="form-control d-block text-truncate border cursor-pointer m-0"
                                        style="cursor: pointer;">
                                        <span class="text-muted"><i class="bi bi-cloud-upload me-2"></i>Pilih
                                            gambar...</span>
                                    </label>
                            ...
                            <div class="mb-3">
                                <label for="tipe" class="form-label">Tipe Kajian <span
                            ...
                            <div class="mb-3">
                                <label for="nama_penceramah" class="form-label">Nama Penceramah <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="nama_penceramah" name="nama_penceramah"
                                    placeholder="Contoh: Ust. Adi Hidayat" required>
                            </div>

                            <div class="mb-3">
                                <label for="tema_kajian" class="form-label">Tema Kajian <span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="tema_kajian" name="tema_kajian"
                                    placeholder="Judul materi kajian" required>
                            </div>

                            <div class="row g-3">
                                <div class="col-7">
                                    <div id="wrapperTanggal" class="d-none">
                                        <label for="tanggal_kajian" class="form-label">Tanggal Event <span
                                                class="text-danger">*</span></label>
                                        <input type="date" class="form-control" id="tanggal_kajian"
                                            name="tanggal_kajian">
                                    </div>

                                    <div id="wrapperHari">
                                        <label for="hari" class="form-label">Hari Rutin <span
                                                class="text-danger">*</span></label>
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            window.editKajian = async function(id) {
                try {
                    ...
                    if (data.waktu_kajian) document.getElementById('waktu_kajian').value = data.waktu_kajian
                        .substring(0, 5);
                    ...
                    if (data.tipe === 'rutin') {
                        ...
                        if (data.tanggal_kajian && inputTanggal) inputTanggal.value = data.tanggal_kajian
                            .split('T')[0];
                    }
            ...
            async function loadKajian() {
                ...
                const url =
                    `/pengurus/kajian-data?page=${state.currentPage}&status=${state.status}&tipe=${state.tipe}&search=${state.search}&sortBy=${state.sortBy}&sortDir=${state.sortDir}`;
                try {
                    const res = await fetch(url);
            ...
            function renderPagination(response) {
                ...
                response.links.forEach(link => {
                    ...
                    linksHtml +=
                        `<li class="page-item ${active} ${disabled}"><a class="page-link" href="${link.url}">${label}</a></li>`;
                });
                linksHtml += '</ul>';
