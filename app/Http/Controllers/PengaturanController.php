...
// Impor yang kita perlukan untuk mengambil data dari API
...
class PengaturanController extends Controller
{
     ...
     * (INI YANG DIUBAH MENJADI SEPERTI JADWAL ADZAN)
     */
    public function edit()
    {
        ...
        //    Kita panggil API untuk mengambil namanya agar field tidak kosong.
     ...
     * (INI YANG DIUBAH, TANPA try...catch di luar)
     */
    public function update(Request $request)
    {
        ...
        // try...catch sudah dihapus sesuai permintaan.
        // Jika validasi gagal, Laravel akan otomatis mengirim respon error 422
        // Jika ada error lain, Laravel akan mengirim respon 500
    }
}